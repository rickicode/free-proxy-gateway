...
def build_mihomo(data: dict) -> str:
    ...
    lines = [
        ...
        "dns:",
        "  enable: true", "  listen: :1053", "  enhanced-mode: fake-ip", "  fake-ip-range: 198.18.0.1/16",
    ...
    rules = [
        ...
        "DOMAIN-SUFFIX,anthropic.com,PROXY-FREE",
        "DOMAIN-SUFFIX,claude.ai,PROXY-FREE",
        "DOMAIN-SUFFIX,perplexity.ai,PROXY-FREE",
        "DOMAIN-SUFFIX,copilot.microsoft.com,PROXY-FREE",
        "DOMAIN-SUFFIX,groq.com,PROXY-FREE",
        "DOMAIN-SUFFIX,mistral.ai,PROXY-FREE",
        # Check IP
        "DOMAIN-SUFFIX,ifconfig.me,PROXY-FREE",
        "DOMAIN-SUFFIX,ifconfig.co,PROXY-FREE",
        "DOMAIN,api.ipify.org,PROXY-FREE",
        "DOMAIN,icanhazip.com,PROXY-FREE",
        "DOMAIN-SUFFIX,ipinfo.io,PROXY-FREE",
        "DOMAIN-SUFFIX,ip.sb,PROXY-FREE",
        "DOMAIN-SUFFIX,ip-api.com,PROXY-FREE",
        "DOMAIN,whatismyipaddress.com,PROXY-FREE",
        "DOMAIN,myip.com,PROXY-FREE",
        "DOMAIN-SUFFIX,ipleak.net,PROXY-FREE",
        "DOMAIN,ip.me,PROXY-FREE",
        # Speedtest
        "DOMAIN-SUFFIX,speedtest.net,PROXY-FREE",
        "DOMAIN-SUFFIX,speedtest.cn,PROXY-FREE",
        "DOMAIN,fast.com,PROXY-FREE",
        "DOMAIN-SUFFIX,fast.com,PROXY-FREE",
        "DOMAIN,speed.cloudflare.com,PROXY-FREE",
        "DOMAIN-SUFFIX,nperf.com,PROXY-FREE",
        "DOMAIN-SUFFIX,speedof.me,PROXY-FREE",
        # Social / Media
        "GEOSITE,github,PROXY-FREE",
        "GEOSITE,telegram,PROXY-FREE",
        "GEOSITE,youtube,PROXY-FREE",
        "GEOSITE,netflix,PROXY-FREE",
        "GEOSITE,twitter,PROXY-FREE",
        "GEOSITE,facebook,PROXY-FREE",
        "GEOSITE,instagram,PROXY-FREE",
        "GEOSITE,reddit,PROXY-FREE",
        "GEOSITE,whatsapp,PROXY-FREE",
        "GEOSITE,spotify,PROXY-FREE",
        # Fallback
        "MATCH,PROXY-FREE",
    ]
    for r in rules:
